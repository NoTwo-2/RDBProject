...
CREATE TABLE `player` (
  ...
  `kill_death_ratio` float DEFAULT NULL,
...
INSERT INTO `sponsor` VALUES ('Monster',1);
...
INSERT INTO `team` VALUES (1,'Test team');
...
INSERT INTO `tournament` VALUES (1,'Test',12,4,1997,'420 Little Ceaser\'s Dr.','Rolla','WI');
...
INSERT INTO `tournament_participant` VALUES (1,1,'Disqualified');
...
-- Dump completed on 2022-12-04 20:05:10
